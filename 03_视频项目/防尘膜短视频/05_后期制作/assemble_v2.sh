...
ROOT="${0:A:h}"
PROJECT="${ROOT:h}"
VISUAL_BANK="$PROJECT/04_AI生成工程/visual-bank-v1"
VOICE="$ROOT/voice"
CTA="$PROJECT/04_AI生成工程/native-audio-cta/clips/variant-01/scene-01.mp4"
BASE="$PROJECT/06_成片/v2/pre-taped-film-ad-v2-base.mp4"
FINAL="$PROJECT/06_成片/v2/pre-taped-film-ad-v2-final.mp4"
